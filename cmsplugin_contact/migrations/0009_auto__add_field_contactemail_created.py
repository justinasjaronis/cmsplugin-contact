...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactEmail.created'
        db.add_column(u'cmsplugin_contact_contactemail', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 6, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactEmail.created'
        db.delete_column(u'cmsplugin_contact_contactemail', 'created')
